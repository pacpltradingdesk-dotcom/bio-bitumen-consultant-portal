...
# ── AI Skill: Tender Strategy ──────────────────────────────────────
st.markdown("---")
try:
    from engines.ai_engine import is_ai_available, ask_ai
    if is_ai_available():
        with st.expander("🤖 AI: Tender Strategy"):
            if st.button("Generate", type="primary", key="ai_12🛣️NH"):
                with st.spinner("AI working..."):
                    _p = f"As a senior bio-bitumen consultant, generate: Tender Strategy. "
