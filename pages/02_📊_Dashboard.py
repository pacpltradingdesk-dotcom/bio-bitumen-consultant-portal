...
with action_col:
    ...
    st.page_link("pages/_detail/21_Capacity_Compare.py", label="Compare Capacities", icon="⚖️")
    st.page_link("pages/09_💰_Financial.py", label="Financial Model", icon="💰")
    st.page_link("pages/_detail/15_DPR_Generator.py", label="Generate DPR", icon="📄")
