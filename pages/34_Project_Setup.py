...
n1.page_link("pages/33_Document_Hub.py", label="Generate Documents", icon="📁")
n2.page_link("pages/07_Financial.py", label="Financial Model", icon="💰")
n3.page_link("pages/15_DPR_Generator.py", label="DPR Generator", icon="📄")
n4.page_link("pages/19_ROI_Quick_Calc.py", label="ROI Calculator", icon="🎯")
