...
# ── AI Skill: Meeting Agenda ──────────────────────────────────────
st.markdown("---")
try:
    from engines.ai_engine import is_ai_available, ask_ai
    if is_ai_available():
        with st.expander("🤖 AI: Meeting Agenda"):
            if st.button("Generate", type="primary", key="ai_70Meeti"):
                with st.spinner("AI working..."):
                    _p = f"As a senior bio-bitumen consultant, generate: Meeting Agenda. "
...
# Print
if st.sidebar.button("Print", key="prt_70Mee"):
