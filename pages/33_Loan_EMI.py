...
# ── AI Skill: Bank Pitch Points ──────────────────────────────────────
st.markdown("---")
try:
    from engines.ai_engine import is_ai_available, ask_ai
    if is_ai_available():
        with st.expander("🤖 AI: Bank Pitch Points"):
            if st.button("Generate", type="primary", key="ai_61Loan"):
                with st.spinner("AI working..."):
                    _p = f"As a senior bio-bitumen consultant, generate: Bank Pitch Points. "
