...
# ── AI Skill: Equipment Recommendations ──────────────────────────────────────
st.markdown("---")
try:
    from engines.ai_engine import is_ai_available, ask_ai
    if is_ai_available():
        with st.expander("🤖 AI: Equipment Recommendations"):
            if st.button("Generate", type="primary", key="ai_07⚙️Pl"):
                with st.spinner("AI working..."):
                    _p = f"As a senior bio-bitumen consultant, generate: Equipment Recommendations. "
