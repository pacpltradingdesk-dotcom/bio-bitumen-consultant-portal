...
n1.page_link("pages/61_📁_Document_Hub.py", label="Generate Documents", icon="📁")
n2.page_link("pages/30_💰_Financial.py", label="Financial Model", icon="💰")
n3.page_link("pages/60_DPR_Generator.py", label="DPR Generator", icon="📄")
n4.page_link("pages/36_ROI_Quick_Calc.py", label="ROI Calculator", icon="🎯")
