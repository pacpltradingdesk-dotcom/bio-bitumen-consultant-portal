...
n2.page_link("pages/_detail/15_DPR_Generator.py", label="Generate DPR Report", icon="📄")
n3.page_link("pages/_detail/00_Client_Journey.py", label="Start Client Journey", icon="🧭")
