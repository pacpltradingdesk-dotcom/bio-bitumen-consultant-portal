...
# ── AI Skill: Biomass Sourcing Plan ──────────────────────────────────────
st.markdown("---")
try:
    from engines.ai_engine import is_ai_available, ask_ai
    if is_ai_available():
        with st.expander("🤖 AI: Biomass Sourcing Plan"):
            if st.button("Generate", type="primary", key="ai_06🌾Raw"):
                with st.spinner("AI working..."):
                    _p = f"As a senior bio-bitumen consultant, generate: Biomass Sourcing Plan. "
