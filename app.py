...
pres2.page_link("pages/10_📝_Project_Setup.py", label="Setup Project", icon="📝")
pres3.page_link("pages/61_📁_Document_Hub.py", label="Document Hub", icon="📁")
...
with st.expander("Client Journey (Step-by-Step Alternative)"):
    ...
    jc1.page_link("pages/14_Client_Journey.py", label="New Investor", icon="🧑‍🌾")
    jc2.page_link("pages/14_Client_Journey.py", label="Bitumen Plant Owner", icon="🛢️")
    jc3.page_link("pages/14_Client_Journey.py", label="Biomass Company", icon="🌾")
    jc4.page_link("pages/14_Client_Journey.py", label="Pyrolysis Owner", icon="🔥")
...
with nav[0]:
    ...
    st.page_link("pages/13_📈_Market.py", label="Market Intelligence", icon="📈")
    st.page_link("pages/12_📍_Location.py", label="Location Analysis", icon="📍")
    st.page_link("pages/24_🌾_Raw_Material.py", label="Raw Material", icon="🌾")

with nav[1]:
    st.markdown("**Engineering**")
    st.page_link("pages/23_⚙️_Plant_Design.py", label="Plant Design", icon="⚙️")
    st.page_link("pages/50_📐_Drawings.py", label="Engineering Drawings", icon="📐")
    st.page_link("pages/20_Technology.py", label="Technology", icon="🔬")
    st.page_link("pages/22_Process_Flow.py", label="Process Flow", icon="🔄")

with nav[2]:
    st.markdown("**Finance & Legal**")
    st.page_link("pages/30_💰_Financial.py", label="Financial Model", icon="💰")
    st.page_link("pages/40_📋_Compliance.py", label="Compliance Tracker", icon="📑")
    st.page_link("pages/70_Buyers.py", label="Buyers Network", icon="🤝")
    st.page_link("pages/71_🏭_Procurement.py", label="Procurement", icon="🏭")
...
with nav[3]:
    ...
    st.page_link("pages/37_Capacity_Compare.py", label="Capacity Compare", icon="⚖️")
    st.page_link("pages/43_🛣️_NHAI_Tenders.py", label="NHAI Tenders", icon="🛣️")
    st.page_link("pages/72_Competitor_Intel.py", label="Competitor Intel", icon="🕵️")
    st.page_link("pages/41_Environmental.py", label="Environmental Impact", icon="🌱")
    st.page_link("pages/42_Risk_Matrix.py", label="Risk Matrix", icon="⚠️")
    st.page_link("pages/75_Weather_Site.py", label="Weather & Site", icon="🌤️")
    st.page_link("pages/52_AI_Plant_Layouts.py", label="AI Plant Layouts", icon="🏗️")

with nav[4]:
    st.markdown("**Client Ops**")
    st.page_link("pages/54_Project_Gantt.py", label="Project Timeline", icon="📅")
    st.page_link("pages/76_Meeting_Planner.py", label="Meeting Planner", icon="📋")
    st.page_link("pages/60_DPR_Generator.py", label="DPR Generator", icon="📄")
    st.page_link("pages/62_Export_Center.py", label="Export Center", icon="📤")
    st.page_link("pages/74_News_Feed.py", label="Industry News", icon="📰")
    st.page_link("pages/78_Training.py", label="Training & SOPs", icon="📚")
    st.page_link("pages/81_🤖_AI_Advisor.py", label="AI Advisor", icon="🤖")
    st.page_link("pages/10_📝_Project_Setup.py", label="Project Setup", icon="📝")
    st.page_link("pages/83_🔑_AI_Settings.py", label="AI Settings", icon="🔑")
    st.page_link("pages/79_System_Calculations.py", label="System & Formulas", icon="🔧")
...
qa1.page_link("pages/10_📝_Project_Setup.py", label="Project Setup", icon="📝")
qa2.page_link("pages/61_📁_Document_Hub.py", label="Document Hub", icon="📁")
qa3.page_link("pages/30_💰_Financial.py", label="Financial Model", icon="💰")
qa4.page_link("pages/36_ROI_Quick_Calc.py", label="Quick ROI Demo", icon="🎯")
qa5.page_link("pages/82_🏥_System_Health.py", label="System Health", icon="🏥")
