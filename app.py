...
pres1.page_link("pages/00_Consultant_Presenter.py", label="START PRESENTATION MODE", icon="🎯")
pres2.page_link("pages/34_Project_Setup.py", label="Setup Project", icon="📝")
pres3.page_link("pages/33_Document_Hub.py", label="Document Hub", icon="📁")
...
with nav[0]:
    ...
    st.page_link("pages/01_Dashboard.py", label="Executive Dashboard", icon="📊")
    st.page_link("pages/02_Market.py", label="Market Intelligence", icon="📈")
    st.page_link("pages/03_Location.py", label="Location Analysis", icon="📍")
    st.page_link("pages/04_Raw_Material.py", label="Raw Material", icon="🌾")

with nav[1]:
    st.markdown("**Engineering**")
    st.page_link("pages/05_Plant_Design.py", label="Plant Design", icon="⚙️")
    st.page_link("pages/06_Drawings.py", label="Engineering Drawings", icon="📐")
...
with nav[2]:
    ...
    st.page_link("pages/07_Financial.py", label="Financial Model", icon="💰")
    st.page_link("pages/09_Compliance.py", label="Compliance Tracker", icon="📑")
    st.page_link("pages/10_Buyers.py", label="Buyers Network", icon="🤝")
    st.page_link("pages/08_Procurement.py", label="Procurement", icon="🏭")
...
with nav[3]:
    ...
    st.page_link("pages/22_NHAI_Tender_Tracker.py", label="NHAI Tenders", icon="🛣️")
...
qa1.page_link("pages/34_Project_Setup.py", label="Project Setup", icon="📝")
qa2.page_link("pages/33_Document_Hub.py", label="Document Hub", icon="📁")
qa3.page_link("pages/07_Financial.py", label="Financial Model", icon="💰")
qa4.page_link("pages/19_ROI_Quick_Calc.py", label="Quick ROI Demo", icon="🎯")
qa5.page_link("pages/18_System_Health.py", label="System Health", icon="🏥")
