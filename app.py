...
with st.expander("Client Journey (Step-by-Step Alternative)"):
    ...
    jc1.page_link("pages/_detail/00_Client_Journey.py", label="New Investor", icon="🧑‍🌾")
    jc2.page_link("pages/_detail/00_Client_Journey.py", label="Bitumen Plant Owner", icon="🛢️")
    jc3.page_link("pages/_detail/00_Client_Journey.py", label="Biomass Company", icon="🌾")
    jc4.page_link("pages/_detail/00_Client_Journey.py", label="Pyrolysis Owner", icon="🔥")
...
with nav[1]:
    ...
    st.page_link("pages/_detail/02a_Technology.py", label="Technology", icon="🔬")
    st.page_link("pages/_detail/02c_Process_Flow.py", label="Process Flow", icon="🔄")
...
with nav[2]:
    ...
    st.page_link("pages/_detail/10_Buyers.py", label="Buyers Network", icon="🤝")
    st.page_link("pages/10_🏭_Procurement.py", label="Procurement", icon="🏭")

with nav[3]:
    st.markdown("**New Tools**")
    st.page_link("pages/_detail/19_ROI_Quick_Calc.py", label="ROI Calculator", icon="🎯")
    st.page_link("pages/_detail/20_Loan_EMI_Calculator.py", label="Loan EMI Calculator", icon="🏦")
    st.page_link("pages/_detail/21_Capacity_Compare.py", label="Capacity Compare", icon="⚖️")
    st.page_link("pages/12_🛣️_NHAI_Tenders.py", label="NHAI Tenders", icon="🛣️")
    st.page_link("pages/_detail/23_Competitor_Intel.py", label="Competitor Intel", icon="🕵️")
    st.page_link("pages/_detail/25_Environmental.py", label="Environmental Impact", icon="🌱")
    st.page_link("pages/_detail/26_Risk_Matrix.py", label="Risk Matrix", icon="⚠️")
    st.page_link("pages/_detail/31_Weather_Site.py", label="Weather & Site", icon="🌤️")

with nav[4]:
    st.markdown("**Client Ops**")
    st.page_link("pages/_detail/24_Project_Gantt.py", label="Project Timeline", icon="📅")
    st.page_link("pages/_detail/30_Meeting_Planner.py", label="Meeting Planner", icon="📋")
    st.page_link("pages/_detail/15_DPR_Generator.py", label="DPR Generator", icon="📄")
    st.page_link("pages/_detail/27_Export_Center.py", label="Export Center", icon="📤")
    st.page_link("pages/_detail/28_News_Feed.py", label="Industry News", icon="📰")
    st.page_link("pages/_detail/29_Training.py", label="Training & SOPs", icon="📚")
    ...
    st.page_link("pages/_detail/32_System_Calculations.py", label="System & Formulas", icon="🔧")
...
qa4.page_link("pages/_detail/19_ROI_Quick_Calc.py", label="Quick ROI Demo", icon="🎯")
